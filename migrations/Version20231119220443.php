 ...
 */
final class Version20231119220443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE ville_id ville_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE ville_id ville_id INT NOT NULL');
    }
}
